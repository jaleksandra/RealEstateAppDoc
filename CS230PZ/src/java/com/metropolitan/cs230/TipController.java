...
public class TipController implements Serializable {
    ...
    @EJB
    private com.metropolitan.cs230.TipFacade ejbFacade;
    ...
    public Tip getTip(java.lang.Integer id) {
    ...
    public static class TipControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getTip(getKey(value));
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Tip) {
                Tip o = (Tip) object;
                return getStringKey(o.getIdTipa());
            } else {
